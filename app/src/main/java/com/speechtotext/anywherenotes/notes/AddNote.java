package com.speechtotext.anywherenotes.notes;
...
public class AddNote extends AppCompatActivity {
    ...
    EditText mVoiceInputTv,noteTitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVoiceInputTv = findViewById(R.id.addNoteContent);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String nContent = mVoiceInputTv.getText().toString();
        ...
        mVoiceInputTv = (EditText) findViewById(R.id.addNoteContent);
